...
describe("when I'm using the entry processor", () => {
    ...
    describe("and im processing contexts", () => {
        ...
        let complexBlackEntry = {value: "black", context:{match:["night"]}};
        let complexSunEntry = {value: "sun", context:{match:["day"]}};
        ...
        describe("and i have complex contexts", function () {
            beforeEach(() => {
                processor = {
        ...
        describe("and i have a mix of contexts", function () {
            beforeEach(() => {
                processor = {
                    hasMatchingContext: (context) => (context.includes("night"))
                };
